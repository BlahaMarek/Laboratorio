...
import { CalibrationDetailModalComponent } from './_components/project/calibration-detail-modal/calibration-detail-modal.component';
...
@NgModule({
  declarations: [
    ...
    CalibrationDetailModalComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
